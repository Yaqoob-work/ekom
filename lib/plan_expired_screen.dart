            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ---------------------------------------------
                  // 1. UPDATE PIN BUTTON (Domain bacha ke rakhega)
                  // ---------------------------------------------
                  TvActionButton(
                    label: 'UPDATE PIN',
                    icon: Icons.refresh_rounded,
                    ...
                    autoFocus: true, 
                    onPressed: () async {
                      // ✅ Cache clear karein lekin Domain rakhein (keepDomain: true)
                  ...
                  // ---------------------------------------------
                  // 2. EXIT APP BUTTON (Sab kuch delete karega)
                  // ---------------------------------------------
                  TvActionButton(
                    label: 'EXIT THE APP',
                    icon: Icons.exit_to_app_rounded,
                    ...
                    autoFocus: false,
                    onPressed: () async {
                      // ✅ Sab kuch clear karein (keepDomain: false - default)
...
// -----------------------------------------------------------
// ✅ TV ACTION BUTTON (Includes Enter Key Fix)
// -----------------------------------------------------------
class TvActionButton extends StatefulWidget {
  final String label;
  final IconData icon;
