...
class _WebSeriesDetailsPageState extends State<WebSeriesDetailsPage>
  ...
  // Homepage पर navigate करने का method
  // void _navigateToHome() {
  //   // Option 1: HomePage को specifically navigate करें
  //   Navigator.pushNamedAndRemoveUntil(
  //     context,
  //     '/mainscreen', // या आपका home route name
  //     (route) => false
  //   );

  // Option 2: अगर आपका home page class name पता है
  // Navigator.pushAndRemoveUntil(
  //   context,
  //   MaterialPageRoute(builder: (context) => HomePage()), // Replace with your HomePage class
  //   (route) => false,
  // );
  // }

  // Keyboard events को handle करने का updated method
  void _handleSeasonsNavigation(RawKeyEvent event) {
    switch (event.logicalKey) {
      ...
      case LogicalKeyboardKey.goBack:
        // Homepage पर जाएं app close करने के बजाय
        // Navigator.of(context).pop(true);
