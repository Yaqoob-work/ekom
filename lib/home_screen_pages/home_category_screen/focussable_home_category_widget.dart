...
class FocussableHomeCategoryWidget extends StatefulWidget {
  ...
  const FocussableHomeCategoryWidget({
  ...
  @override
  _FocussableHomeCategoryWidgetState createState() => _FocussableHomeCategoryWidgetState();
}

class _FocussableHomeCategoryWidgetState extends State<FocussableHomeCategoryWidget> {
