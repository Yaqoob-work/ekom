...
//     return Container(
//       padding: EdgeInsets.symmetric(vertical: main.screenhgt * 0.01),
//       height: main.screenhgt * 0.1, // Parent container height
//       child: Row(
//         children: [
...
//                             main.screenwdt * 0.001), // Reduced padding
...
//                               category,
//                               style: TextStyle(
//                                 fontSize: main.menutextsz,
//                                 color: _selectedCategory == category
//                                     ? main.borderColor
//                                     : (hasFocus ? currentColor : main.hintColor),
//                                 fontWeight:
...
//                               style: TextStyle(
//                                 fontSize: main.menutextsz,
//                                 color: hasFocus ? currentColor : main.hintColor,
//                                 fontWeight: hasFocus
//                                     ? FontWeight.bold
//                                     : FontWeight.normal,
//                               ),
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      setState(() {
        ...
        // print('   🎬 Movies: ${_apiService.movieList.length}');
        // print('   🎵 Music: ${_apiService.musicList.length}');
        ...
        switch (_selectedCategory.toLowerCase()) {
          case 'live':
            _musicList.addAll(_apiService.allChannelList);
            // print('🔄 Added ${_apiService.allChannelList.length} Live channels');
            break;
          case 'entertainment':
            _musicList.addAll(_apiService.entertainmentList);
            // print('🔄 Added ${_apiService.entertainmentList.length} Entertainment channels');
            break;
          case 'music':
            _musicList.addAll(_apiService.musicList);
            // print('🔄 Added ${_apiService.musicList.length} Music channels');
            break;
          case 'movie':
            _musicList.addAll(_apiService.movieList);
            // print('🔄 Added ${_apiService.movieList.length} Movie channels');
            break;
          case 'news':
            _musicList.addAll(_apiService.newsList);
            // print('🔄 Added ${_apiService.newsList.length} News channels');
            break;
          case 'sports':
            _musicList.addAll(_apiService.sportsList);
            // print('🔄 Added ${_apiService.sportsList.length} Sports channels');
            break;
          case 'religious':
            _musicList.addAll(_apiService.religiousList);
            // print('🔄 Added ${_apiService.religiousList.length} Religious channels');
            break;
          default:
            _musicList.addAll(_apiService.musicList);
        ...
        if (_musicList.isNotEmpty) {
          ...
          // print('   ID: ${_musicList[0].id}');
          // print('   Name: ${_musicList[0].name}');
          // print('   Genre: ${_musicList[0].genres}');
          // print('   Index: ${_musicList[0].index}');
        } else {
