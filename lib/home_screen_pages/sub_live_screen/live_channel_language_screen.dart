...
//   // // ✅ FIXED: Reduced card dimensions to prevent overflow
//   // static const double bannerwdt = 140.0;
//   // static const double bannerhgt = 160.0;
//   // static const double focussedBannerhgt = 180.0;
...
//     final String uniqueImageUrl = "${widget.language.logoUrl}?v=${DateTime.now().millisecondsSinceEpoch}";
//     final String uniqueCacheKey = "${widget.language.id.toString()}_${DateTime.now().millisecondsSinceEpoch}";
...
//     String languageType = 'HD';
//     Color badgeColor = ProfessionalColors.accentBlue;

//     // You can customize badge colors based on language if needed
//     if (widget.language.title.toLowerCase().contains('hindi')) {
//       languageType = 'HINDI';
//       badgeColor = ProfessionalColors.accentGreen;
//     } else if (widget.language.title.toLowerCase().contains('english')) {
//       languageType = 'ENGLISH';
//       badgeColor = ProfessionalColors.accentRed;
//     } else if (widget.language.title.toLowerCase().contains('regional')) {
...
//   void _handleLanguageTap(Language language) {
//     if (_isNavigating) return;
//     _isNavigating = true;

//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(
//         content: Text("${language.title} selected!"),
...
//     child: Container( 
//       // height: screenHeight * 0.32, // <-- REMOVE THIS LINE
//       child: ListView.builder(
//         scrollDirection: Axis.horizontal,
//         clipBehavior: Clip.none,
//         controller: _scrollController,
...
//   //               _buildProfessionalTitle(screenwdt),
//   //               SizedBox(height: screenhgt * 0.01),
//   //               Expanded(child: _buildBody(screenwdt, screenhgt)),
//   //             ],
//   //           ),
//   //         ),
//   //       );
...
//               _buildProfessionalTitle(screenwdt),
//               SizedBox(height: screenhgt * 0.01),
//               // ✅ FIX: Use Expanded to fill the remaining space flexibly.
//               Expanded(
//                 child: _buildBody(screenwdt, screenhgt),
//               ), 
//             ],
//           ),
//         ),
