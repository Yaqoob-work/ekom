...
//       width: double.infinity,
//       height: double.infinity,
//       // This condition checks if the logo URL is present
//       child: widget.tournament.logo != null && widget.tournament.logo!.isNotEmpty
//           ? Image.network( // If yes, display the image from the URL
//               widget.tournament.logo!,
//               fit: BoxFit.cover,
//               loadingBuilder: (context, child, loadingProgress) {
//                 if (loadingProgress == null) return child;
//                 return _buildImagePlaceholder(); // Show placeholder while loading
//               },
//               errorBuilder: (context, error, stackTrace) =>
//                   _buildImagePlaceholder(), // Show placeholder on error
//             )
//           : _buildImagePlaceholder(), // If no, display the placeholder
//     );
//   }
