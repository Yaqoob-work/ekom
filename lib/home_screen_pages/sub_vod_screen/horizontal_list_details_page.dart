...
// // Replace your existing loading overlay code in the build method with this:
...
//               ),
//             ),
//           // Initial Loading Indicator - FIXED CENTERING
//           if (isLoading && genreContentMap.isEmpty)
//             Positioned.fill(
//               child: Container(
//                 color: Colors.black.withOpacity(0.7),
...
// // Also update your _buildContent method to handle the loading state properly:
// Widget _buildContent() {
//   if (isLoading && genreContentMap.isEmpty) {
//     // Return empty container since overlay will show loading
//     return Container();
//   } else if (errorMessage != null && genreContentMap.isEmpty) {
//     return _buildErrorWidget();
//   } else if (genreContentMap.isEmpty) {
