...
// // // import 'package:mobi_tv_entertainment/home_screen_pages/HorizontalVod_screen/HorizontalVod_details_page.dart';
...
// //     print('✅ CONTENTS focus nodes initialized');
// //   }
...
// //         print('🎯 CONTENTS: Scrollable.ensureVisible for index $index: ${HorizontalVodList[index].name}');
// //       }
...
// //       print('🎯 CONTENTS: Scrollable.ensureVisible for ViewAll button');
// //     }
// //   }

// //   // ✅ Setup CONTENTS Focus Provider
...
// //               });
// //               _scrollToPosition(0);
// //               print('✅ CONTENTS received focus from webseries and scrolled');
// //             }
// //           });

// //           // ✅ CONTENTS का first focus node register करें
// //           focusProvider.setFirstHorizontalListNetworksFocusNode(_firstHorizontalVodFocusNode!);

// //           print('✅ CONTENTS first focus node registered: ${HorizontalVodList[0].name}');

// //         } catch (e) {
// //           print('❌ CONTENTS focus provider setup failed: $e');
// //         }
// //       }
// //     });
// //   }

// //   Future<void> fetchHorizontalVod() async {
// //     try {
...
// //         setState(() {
// //           HorizontalVodList = jsonData.map((item) => HorizontalVodModel.fromJson(item)).toList();
// //           isLoading = false;
// //         });
...
// //   //   //       id: HorizontalVod.id,
// //   //   //       banner: HorizontalVod.banner ?? HorizontalVod.poster ?? '',
// //   //   //       poster: HorizontalVod.poster ?? HorizontalVod.banner ?? '',
// //   //   //       name: HorizontalVod.name,
// //   //   //     ),
// //   //   //   ),
// //   //   // ).then((_) {
...
// // // ✅ Updated _navigateToHorizontalVodDetails method for your main CONTENTS widget
// // void _navigateToHorizontalVodDetails(HorizontalVodModel HorizontalVod) {
// //   print('🎬 Navigating to TV Show Details: ${HorizontalVod.name}');
...
// //         tvChannelId: HorizontalVod.id, // TV Show का ID pass करें
...
// //     print('🎬 Navigating to CONTENTS Grid Page...');
...
// //       ),
// //     ).then((_) {
// //       print('🔙 Returned from CONTENTS grid page');
// //       Future.delayed(Duration(milliseconds: 300), () {
...
// //                     //         print('✅ Navigating back to webseries from CONTENTS ViewAll');
// //                     //       } catch (e) {
...
// //           //         // Provider.of<FocusProvider>(context, listen: false)
// //           //         //     .requestFirstWebseriesFocus();
// //           //         print('✅ Navigating back to webseries from CONTENTS');
// //           //       } catch (e) {
// //           //         print('❌ Failed to navigate to webseries: $e');
// //           //       }
// //           //     }
...
// // // ✅ Professional View All Button for CONTENTS
...
// // // ✅ Professional Loading Indicator for CONTENTS
...
// // // ✅ Professional CONTENTS Grid Page
...
// //                   ),
// //                   child: Text(
// //                     '${widget.HorizontalVodList.length} CONTENTS Available',
// //                     style: const TextStyle(
// //                       color: ProfessionalColors.accentGreen,
// //                       fontSize: 12,
// //                       fontWeight: FontWeight.w500,
...
// // 🚀 Enhanced Vod Service with Caching (Similar to Movies)
...
//         print('✅ Successfully loaded ${HorizontalVod.length} fresh Vod from API');
//         return HorizontalVod;
...
//   Widget _buildBody(double screenWidth, double screenHeight) {
//     if (isLoading) {
//       return ProfessionalHorizontalVodLoadingIndicator(message: 'Loading CONTENTS...');
//     } else if (HorizontalVodList.isEmpty) {
//       return _buildEmptyWidget();
//     } else {
//       return _buildHorizontalVodList(screenWidth, screenHeight);
...
// // ✅ Professional TV Show Card (Remaining UI components stay the same as before)
// class ProfessionalHorizontalVodCard extends StatefulWidget {
//   final HorizontalVodModel HorizontalVod;
//   final FocusNode focusNode;
//   final VoidCallback onTap;
...
// // ✅ Professional CONTENTS Grid Page - Complete Implementation
// class ProfessionalHorizontalVodGridPage extends StatefulWidget {
//   final List<HorizontalVodModel> HorizontalVodList;
//   final String title;
