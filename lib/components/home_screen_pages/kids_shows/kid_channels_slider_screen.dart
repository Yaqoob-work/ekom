...
// //==============================================================================
// // SECTION 1: COMMON CLASSES AND MODELS (REFACTORED FOR KIDS)
// //==============================================================================
...
//     required this.updatedAt, this.genre, required this.order, this.language,
//   });

//   factory KidChannelsModel.fromJson(Map<String, dynamic> json) {
//     String extractedImage = '';
//     if (json['logo'] != null) extractedImage = json['logo'];
//     else if (json['thumbnail'] != null) extractedImage = json['thumbnail'];
//     else if (json['poster'] != null) extractedImage = json['poster'];
...
//     this.genre, required this.kidChannelsId, required this.order,
//   });
...
//     required this.networksOrder, this.sliders = const [],
//   });
...
// class ProfessionalKidChannelsLoadingIndicator extends StatelessWidget {
//   final String message;
//   const ProfessionalKidChannelsLoadingIndicator({Key? key, required this.message}) : super(key: key);
...
//             decoration: BoxDecoration(
//               shape: BoxShape.circle,
//               gradient: LinearGradient(colors: KidChannelsColors.gradientColors),
//             ),
...
//           Text(
//             message,
//             style: const TextStyle(color: KidChannelsColors.textPrimary, fontSize: 16, fontWeight: FontWeight.w500),
//           ),
//         ],
//       ),
//     );
...
//   Future<List<KidChannelsModel>> _fetchKidChannelsForNetwork(int networkId) async {
//     try {
//       String authKey = SessionManager.authKey;
//       var url = Uri.parse(SessionManager.baseUrl + 'getKidsChannels?content_network=$networkId');
//       final response = await https.get(
//         url,
//         headers: {
//           'auth-key': authKey,
...
//         return jsonData.map((item) => KidChannelsModel.fromJson(item as Map<String, dynamic>)).toList()..sort((a, b) => a.order.compareTo(b.order));
//       } else {
//         throw Exception('API Error: ${response.statusCode}');
//       }
//     } catch (e) {
//       if (!_isDisposed) debugPrint('Failed to load kid channels: $e');
//       return [];
//     }
//   }

//   Future<List<KidChannelsShowItemModel>> _fetchKidChannelsShowsForChannel(int channelId) async {
//     String authKey = SessionManager.authKey;
//     var url = Uri.parse(SessionManager.baseUrl + 'getKidsShows/$channelId');
//     try {
//       final response = await https.get(
...
//         final dynamic _decoded_jsonData = json.decode(response.body);
//         final List<dynamic> jsonData = safeDecodeList(_decoded_jsonData);
//         return jsonData.map((item) => KidChannelsShowItemModel.fromJson(item as Map<String, dynamic>)).toList()..sort((a, b) => a.order.compareTo(b.order));
//       } else {
//         throw Exception('API Error: ${response.statusCode}');
//       }
//     } catch (e) {
//       if (!_isDisposed) debugPrint('Failed to load shows: $e');
//       return [];
//     }
//   }
...
//       }
//     } catch (e) {
//       if (!_isDisposed) debugPrint('Failed to load networks: $e');
//       return [];
//     }
//   }
...
//   KeyEventResult _onKeyHandler(FocusNode node, RawKeyEvent event) {
//     if (_isDisposed || event is! RawKeyDownEvent || _isListLoading || _isLoading)
//       return KeyEventResult.ignored;
...
//         newMasterList = showItems.map((show) => KidChannelsModel(
//               id: show.id,
//               title: show.title,
//               image: show.thumbnail,
//               updatedAt: '',
...
//     if (_sliderPageController.hasClients && _currentKidChannelsSliders.isNotEmpty) {
//       _sliderPageController.jumpToPage(0);
//     }
//   }
...
//   Future<void> _navigateToKidChannelsDetails(KidChannelsModel item, int index) async {
...
//               _updateAndScrollToFocus(_itemFocusNodes, _focusedItemIndex, _listScrollController, (bannerwdt * 1.1) + 15);
//             }
//           });
//         } else {
//           _focusedItemIndex = -1;
...
//                     color: Colors.white.withOpacity(0.05),
//                     borderRadius: BorderRadius.circular(10),
//                     border: Border.all(color: KidChannelsColors.accentPurple, width: 2),
//                   ),
//                   child: Text(
//                     _searchText.isEmpty ? 'Start typing...' : _searchText,
//                     textAlign: TextAlign.center,
...
//                       imageUrl: item.image,
//                       fit: BoxFit.cover,
//                       placeholder: (context, url) => Container(color: KidChannelsColors.cardDark),
//                       errorWidget: (context, url, error) => Container(
//                         color: KidChannelsColors.cardDark,
//                         child: const Center(
//                           child: Icon(Icons.toys_outlined, color: Colors.white24, size: 40),
//                         ),
//                       ),
//                     )
//                   : Container(
...
//           ),
//           title: item.title,
//           width: bannerwdt * 1.1, // Matches layout size defined in _buildKidChannelsList
//           height: cardHeight,
//           isFocused: isFocused,
//           focusGlowColor: focusColor,
...
class _KidChannelsSliderScreenState extends State<KidChannelsSliderScreen> {
  ...
  void _onTap(KidChannelsModel item, int index) async {
    if (_isVideoLoading || _isDisposed) return;
    setState(() => _isVideoLoading = true);
