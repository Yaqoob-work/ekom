...
// import 'package:mobi_tv_entertainment/components/video_widget/video_screen.dart';
// import 'package:mobi_tv_entertainment/components/widgets/models/news_item_model.dart';
// import 'package:mobi_tv_entertainment/components/services/professional_colors_for_home_pages.dart'; // Ensure this exists
// import 'package:provider/provider.dart';
// import 'package:shared_preferences/shared_preferences.dart';
...
// //==============================================================================
// // ✅ 3. BEAUTIFUL SMART RETRY BUTTON (New Component)
// //==============================================================================
// class BannerSmartRetryButton extends StatefulWidget {
//   final VoidCallback onTap;
//   final FocusNode focusNode;

//   const BannerSmartRetryButton({Key? key, required this.onTap, required this.focusNode}) : super(key: key);

//   @override
//   _BannerSmartRetryButtonState createState() => _BannerSmartRetryButtonState();
// }

// class _BannerSmartRetryButtonState extends State<BannerSmartRetryButton> {
...
//             return KeyEventResult.handled;
//           }
//           // ✅ Navigation Logic specifically for Banner position
//           if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
//             // Banner sabse upar hai, to Arrow Up se Top Navigation (Logo/Search) par jana chahiye
//             context.read<FocusProvider>().updateLastFocusedIdentifier('watchNow');
//             context.read<FocusProvider>().requestFocus('topNavigation'); 
//             return KeyEventResult.handled;
//           }
//           if (event.logicalKey == LogicalKeyboardKey.arrowDown) {
//             // Niche Live Channels ya jo bhi next row hai
//             context.read<FocusProvider>().updateLastFocusedIdentifier('watchNow');
...
//                   )
//                 : null,
//             color: _hasFocus ? null : Colors.grey[100], 
//             borderRadius: BorderRadius.circular(30),
//             border: Border.all(
//               color: _hasFocus ? Colors.white : Colors.grey.withOpacity(0.5),
//               width: 2,
//             ),
//             boxShadow: _hasFocus
//                 ? [
...
//                 size: 20,
//                 color: _hasFocus ? Colors.white : ProfessionalColorsForHomePages.accentBlue,
//               ),
...
//     _shimmerController.dispose();
//     _timer?.cancel();
//     _retryFocusNode.dispose(); // ✅ Dispose Retry Node
//     super.dispose();
//   }
...
//     // Register widget.focusNode initially (Success State Assumption)
//     _registerFocusNode(widget.focusNode);

//     await _fetchBannersWithCache();
//   }

//   // Helper to register nodes cleanly based on state
...
//           bannerList = [];
//         });
//         // ✅ ERROR STATE: Switch registration to Retry Node
...
//       // ✅ SUCCESS STATE: Switch registration back to Main Focus Node
//       _registerFocusNode(widget.focusNode);
...
//   // ✅ UPDATED BEAUTIFUL ERROR WIDGET
//   Widget _buildErrorWidget() {
//     return Center(
//       child: Container(
...
//             Text(
//               "Unable to load latest banners",
//               style: TextStyle(color: Colors.grey[600], fontSize: 12),
//             ),
//             const SizedBox(height: 25),
            
//             // ✅ Beautiful Smart Retry Button
//             BannerSmartRetryButton(
//               onTap: refreshData,
...
//   // Focusable Banner Interaction Area
//   Widget _buildNavigationButton() {
//     final bool hasFocus = widget.focusNode.hasFocus;
...
//     double effectiveScreenHeight = screenhgt ?? MediaQuery.of(context).size.height;
//     double effectiveScreenWidth = screenwdt ?? MediaQuery.of(context).size.width;
//     double effectiveMenuTextSz = menutextsz ?? 16.0;
...
//       child: Focus(
//         focusNode: widget.focusNode,
//         onKeyEvent: _handleKeyEvent, // Connects key events to main slider
//         child: GestureDetector(
//           onTap: _handleWatchNowTap,
//           child: AnimatedContainer(
//             duration: const Duration(milliseconds: 200),
...
//               mainAxisSize: MainAxisSize.min,
//               children: [
//                 Icon(Icons.chevron_left, color: hasFocus ? focusColor : Colors.grey[600], size: effectiveMenuTextSz * 1.5),
//                 const SizedBox(width: 8),
//                 Icon(Icons.chevron_right, color: hasFocus ? focusColor : Colors.grey[600], size: effectiveMenuTextSz * 1.5),
//               ],
//             ),
//           ),
//         ),
...
//             imageUrl: uniqueImageUrl,
//             fit: BoxFit.fill,
//             placeholder: (context, url) => Image.asset('assets/streamstarting.gif', fit: BoxFit.fill, width: effectiveScreenWidth, height: effectiveScreenHeight),
//             errorWidget: (context, url, error) => Image.asset('assets/streamstarting.gif', fit: BoxFit.fill, width: effectiveScreenWidth, height: effectiveScreenHeight),
//             cacheKey: uniqueCacheKey,
//             fadeInDuration: const Duration(milliseconds: 100),
//             placeholderFadeInDuration: Duration.zero,
//             useOldImageOnUrlChange: true,
...
//             height: effectiveScreenHeight,
//           ),
//           // Gradient Shimmer Overlay when focused
//           if (isButtonFocused)
//             AnimatedBuilder(
//               animation: _shimmerAnimation,
//               builder: (context, child) {
...
//       }
//     } else if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
//        // Explicitly focus Top Navigation
//        context.read<ColorProvider>().resetColor();
//        focusProvider.requestFocus('topNavigation');
//        return KeyEventResult.handled;
//     } else if (event.logicalKey == LogicalKeyboardKey.arrowDown) {
//        // Focus Next Row (Live Channels)
//        node.unfocus();
//        widget.onFocusChange?.call(false);
//        context.read<ColorProvider>().resetColor();
//        focusProvider.updateLastFocusedIdentifier('watchNow'); // Sync state
...
//   void _startAutoSlide() {
//     _timer?.cancel();
//     if (widget.focusNode.hasFocus) return; // Don't slide if focused
