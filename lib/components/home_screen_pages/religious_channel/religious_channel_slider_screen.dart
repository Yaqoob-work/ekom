...
//     this.poster, this.banner, this.genre, required this.order, this.language,
//   });
...
//   ReligiousShowItemModel({
//     required this.id, required this.title, this.thumbnail,
//     this.genre, required this.religiousChannelId, required this.order,
//   });
...
// class ProfessionalReligiousLoadingIndicator extends StatelessWidget {
//   final String message;
//   const ProfessionalReligiousLoadingIndicator({Key? key, required this.message}) : super(key: key);
...
//   @override
//   void dispose() {
//     _isDisposed = true; // CRASH FIX: Set First
//     _sliderTimer?.cancel();
//     _debounce?.cancel();
//     _navigationLockTimer?.cancel();
...
//       }
//     } catch (e) {
//       if (!_isDisposed) debugPrint('Failed to load religious shows for channel $channelId: $e');
//       return [];
//     }
//   }
...
//         setState(() { _showKeyboard = true; _focusedKeyRow = 0; _focusedKeyCol = 0; });
//         WidgetsBinding.instance.addPostFrameCallback((_) {
//           if (!_isDisposed && mounted && _keyboardFocusNodes.isNotEmpty) { _keyboardFocusNodes[0].requestFocus(); }
//         });
//         return KeyEventResult.handled;
//       }
//       if (key == LogicalKeyboardKey.arrowLeft) {
...
//                         child: const Center(
//                           child: Icon(Icons.temple_hindu_outlined, color: Colors.white24, size: 40),
//                         ),
//                       ),
//                     )
//                   : Container(
...
//           ),
//           title: item.name,
//           width: bannerwdt * 1.1, // Matches layout size defined in _buildReligiousList
//           height: cardHeight,
//           isFocused: isFocused,
//           focusGlowColor: focusColor,
...
class _ReligiousChannelSliderScreenState extends State<ReligiousChannelSliderScreen> {
  ...
  void _onTap(ReligiousChannelModel item, int index) async {
    if (_isVideoLoading || _isDisposed) return;
    setState(() => _isVideoLoading = true);
