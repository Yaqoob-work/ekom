...
class  ManageReligiousShows extends StatefulWidget {
  ...
  @override
  _ManageReligiousShowsState createState() =>
      _ManageReligiousShowsState();
}

class _ManageReligiousShowsState
    extends State< ManageReligiousShows>
    ...
    return Focus(
      ...
      if (event is RawKeyDownEvent) {
        ...
        if (key == LogicalKeyboardKey.arrowRight ||
          ...
          // 3. अब फोकस बदलें
          if (key == LogicalKeyboardKey.arrowRight) {
            if (index < channelsList.length - 1 && index < maxHorizontalItems - 1) {
              String nextChannelId = channelsList[index + 1].id.toString();
              FocusScope.of(context)
                  .requestFocus(channelsFocusNodes[nextChannelId]);
