...
//       Future.delayed(Duration(milliseconds: 500), () {
//         if (mounted &&
//             displayChannelsList.isNotEmpty &&
//             fullChannelsList.isEmpty) {
//           print('🚀 Smart preloading full channels list...');
...
//       print(
//           '✅ Cache data loaded instantly: ${cachedData.length} channels (both display and full list)');
...
//           print(
//               '✅ Both display (${displayChannelsList.length}) and full (${fullChannelsList.length}) lists populated');
//         }
//       } else {
//         if (mounted) {
//           setState(() {
...
//           print(
//               '✅ Cache and full list updated with fresh data (${freshData.length} channels)');
//         } else {
//           print('✅ Cache data is already fresh, no update needed');
//         }
//       }
...
//     } else {
//       print(
//           '⚠️ Using display channels list as fallback: ${displayChannelsList.length} channels');
...
//       int focusedIndex = displayChannelsList
//           .indexWhere((channel) => channel.id.toString() == itemId);
...
//           if (mounted) {
//             final channelIndex =
//                 activeChannels.indexWhere((ch) => ch.id == channel.id);
...
//                 FocusScope.of(context)
//                     .requestFocus(_channelFocusNodes[channelId]);
...
//           bottom: BorderSide(
//             color: ProfessionalColors.accentGreen
//                 .withOpacity(0.2), // Live theme color
...
//             if (!_channelFocusNodes.containsKey(channelId)) {
//               print(
//                   '⚠️ Channel grid focus node not found for Channel: $channelId');
