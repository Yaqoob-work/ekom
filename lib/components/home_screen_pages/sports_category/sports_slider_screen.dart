...
// // Model: SportsShowItemModel (Matches/Tournaments)
// class SportsShowItemModel {
//   final int id;
//   final String title;
//   final String? logo;
...
// class ProfessionalSportsLoadingIndicator extends StatelessWidget {
//   final String message;
//   const ProfessionalSportsLoadingIndicator({Key? key, required this.message}) : super(key: key);
...
//       }
//     } catch (e) {
//       if (!_isDisposed) debugPrint('Failed to load sports shows for channel $channelId: $e');
//       return [];
//     }
//   }
...
//                         child: const Center(
//                           child: Icon(Icons.sports_soccer_outlined, color: Colors.white24, size: 40),
//                         ),
//                       ),
//                     )
//                   : Container(
...
//           ),
//           title: item.title,
//           width: bannerwdt * 1.1, // Matches layout size defined in _buildSportsList
//           height: cardHeight,
//           isFocused: isFocused,
//           focusGlowColor: focusColor,
...
class _SportsSliderScreenState extends State<SportsSliderScreen> {
  bool _isDisposed = false;
  bool _isLoading = true;
  bool _isVideoLoading = false;
  String? _errorMessage;
  ...
  void _onSearch(String query) {
    setState(() {
      _searchText = query;
      // Note: Because sports displayList changes on filter, local filter is applied here.
      // Ideally you preserve a _masterList, but keeping simple as per original logic.
    });
  }

  void _onTap(SportsChannelModel item, int index) async {
    if (_isVideoLoading || _isDisposed) return;
    setState(() => _isVideoLoading = true);
