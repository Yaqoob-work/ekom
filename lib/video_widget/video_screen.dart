...
// // Note: VideoPlayerService is no longer needed for this screen.
// // You can remove the import if it's not used elsewhere.
...
// class _VideoScreenState extends State<VideoScreen> {
//   // Player is now a local instance, not from a static service.
...
//   // Variables for "Seek on Release" functionality
//   Timer? _seekAccumulatorTimer;
//   Duration _accumulatedSeekDuration = Duration.zero;
//   int _seekDirection = 0; // 0 = stopped, 1 = forward, -1 = backward
//   bool _isPreviewingSeek = false;
...
//     // Initialize the player and controller here.
//     player = Player(
//       configuration: const PlayerConfiguration(
//         vo: 'gpu', // Use hardware acceleration
...
//     // Properly dispose of the player to release all resources.
//     player.dispose();
...
//     // Fast-forward/rewind at a rate of 30 seconds per second of holding the key.
//     const seekSpeedFactor = Duration(seconds: 30);
//     const timerInterval = Duration(milliseconds: 100);
...
//         // Clamp the preview position to be within the video duration.
//         if (_previewPosition < Duration.zero) _previewPosition = Duration.zero;
//         if (_previewPosition > totalDuration) _previewPosition = totalDuration;
//       });
//     });
...
//                   ),
//                   AnimatedOpacity(
//                     opacity: _controlsVisible && !_isPreviewingSeek ? 1.0 : 0.0,
//                     duration: const Duration(milliseconds: 300),
//                     child: _buildCustomControls(),
//                   ),
//                   if (_isPreviewingSeek) _buildSeekPreviewOverlay(),
