...
// //     final apiUrl =
// //         'https://dashboard.cpplayers.com/public/api/getEpisodes/$seasonId/0';
...
//   static String get baseUrl => 'https://dashboard.cpplayers.com/public/api/';
// }
...
//       modifiedUrl =
//           '${widget.videoUrl}?network-caching=5000&live-caching=2000&rtsp-tcp';
//     } else {
...
//   // यह ट्रैक करेगा कि किस दिशा में सीक करना है: 1 (आगे), -1 (पीछे), 0 (बंद)
...
//   void dispose() {
//     _hideControlsTimer?.cancel();
//     _continuousSeekTimer?.cancel(); // नए टाइमर को भी dispose करें
//     player.dispose();
//     _focusNode.dispose();
//     KeepScreenOn.turnOff();
//     super.dispose();
...
//     if (widget.liveStatus) return; // लाइव वीडियो में सीक नहीं करना

//     final direction = forward ? 1 : -1;
//     // अगर पहले से ही उसी दिशा में सीक हो रहा है, तो कुछ न करें
//     if (_seekDirection == direction) return;

//     _seekDirection = direction;

//     // एक बार तुरंत सीक करें ताकि यूजर को तुरंत फीडबैक मिले
//     _performSeekStep();

//     // अब हर 200 मिलीसेकंड में लगातार सीक करने के लिए टाइमर शुरू करें
...
//     // हर स्टेप में कितना सीक करना है, यह आप बदल सकते हैं
//     final seekAmount = Duration(seconds: 30);

//     var newPosition = currentPosition + (seekAmount * _seekDirection);

//     // सुनिश्चित करें कि नई पोजीशन वीडियो की ड्यूरेशन के अंदर ही रहे
...
//     // किसी भी की-प्रेस पर कंट्रोल्स दिखाएं
//     _resetHideControlsTimer();

//     // सिर्फ Arrow keys के लिए खास लॉजिक
//     if (event.logicalKey == LogicalKeyboardKey.arrowLeft ||
//         event.logicalKey == LogicalKeyboardKey.arrowRight) {
//       // जब की-बोर्ड का बटन दबाया जाए
//       if (event is KeyDownEvent) {
//         _startContinuousSeek(event.logicalKey == LogicalKeyboardKey.arrowRight);
//       }
//       // जब की-बोर्ड का बटन छोड़ा जाए
...
//     // अगर कोई और बटन दबाया जाता है, तो चल रही सीकिंग को रोक दें
//     if (event is KeyDownEvent) {
//       _stopContinuousSeek();
//     }
