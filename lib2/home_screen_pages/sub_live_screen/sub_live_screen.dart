...
//     // 🔧 FIX: Focus listener को initState में add करें
//     widget.focusNode.addListener(_handleFocusChange);

//     // 🔧 FIX: Post frame callback में initial focus state check करें
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       _checkInitialFocusState();
//     });
//   }

//   // 🔧 NEW: Initial focus state को check करने के लिए method
//   void _checkInitialFocusState() {
...
//   void _handleFocusChange() async {
//     // 🔧 FIX: Focus state को immediately update करें
//     final bool currentlyFocused = widget.focusNode.hasFocus;

//     if (_isFocused == currentlyFocused) return; // Avoid unnecessary updates
...
//     if (_isFocused) {
//       // 🔧 FIX: Animation को immediately start करें
//       _scaleController.forward();
//       _glowController.forward();
...
//         _dominantColor = ProfessionalSubLiveColors.accentBlue;
//         widget.onColorChange(_dominantColor);
//         // 🔧 FIX: setState को call करें color change के बाद
//         setState(() {});
//       } else {
//         try {
//           _dominantColor = await _paletteColorService.getSecondaryColor(
...
//           );
//           widget.onColorChange(_dominantColor);
//           // 🔧 FIX: setState को call करें color extraction के बाद
//           if (mounted) {
//             setState(() {});
//           }
//         } catch (e) {
...
//     // 🔧 FIX: AnimatedBuilder को simplify करें
//     return AnimatedBuilder(
...
//   // 🔧 FIX: Build method में poster height calculation को improve करें
//   Widget _buildProfessionalPoster(double screenWidth, double screenHeight) {
//     // 🔧 FIX: Height calculation को more responsive बनाएं
//     final posterHeight = _isFocused ? screenHeight * 0.25 : screenHeight * 0.20;

//     return AnimatedContainer(
//       // 🔧 FIX: AnimatedContainer use करें smooth transition के लिए
//       duration: SubLiveAnimationTiming.medium,
//       curve: Curves.easeOutCubic,
//       margin: EdgeInsets.only(top: 15),
//       height: posterHeight,
...
//   Map<String, FocusNode> categoryFocusNodes = {};
//   late FocusNode moreFocusNode;
//   late FocusNode viewAllFocusNode;
...
//     // Initialize View All focus node
//     viewAllFocusNode = FocusNode();
...
//     // 🔧 FIX: Register initial focus with proper delay
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       Future.delayed(Duration(milliseconds: 300), () {
//         final firstCategoryNode = categoryFocusNodes[categories.first];
//         if (firstCategoryNode != null && mounted) {
//           context
//               .read<FocusProvider>()
//               .setFirstMusicItemFocusNode(firstCategoryNode);

//           // 🔧 FIX: Auto focus on first item after data loads
//           if (_musicList.isNotEmpty) {
//             final firstItemId = _musicList[0].id;
//             if (newsItemFocusNodes.containsKey(firstItemId)) {
//               final focusNode = newsItemFocusNodes[firstItemId]!;
...
//   // 🔧 FIX: Improved focus nodes initialization
//   void _initializeNewsItemFocusNodes() {
//     // 🔧 FIX: Clear existing nodes properly
//     for (var node in newsItemFocusNodes.values) {
//       node.dispose();
//     }
//     newsItemFocusNodes.clear();
...
//     // 🔧 FIX: Auto focus first item if this is initial load
//     if (_musicList.isNotEmpty && mounted) {
//       WidgetsBinding.instance.addPostFrameCallback((_) {
//         final firstItemId = _musicList[0].id;
//         final firstNode = newsItemFocusNodes[firstItemId];
//         if (firstNode != null && mounted) {
...
//             return KeyEventResult.handled;
//           } else if (event.logicalKey == LogicalKeyboardKey.arrowRight) {
//             // 10th item (index 9) के बाद View All पर focus करें
//             if (_musicList.length > 10 && index == 9) {
//               // यह 10th item है, अब View All पर focus करें
//               FocusScope.of(context).requestFocus(viewAllFocusNode);
//               return KeyEventResult.handled;
...
//     moreFocusNode.dispose();
//     viewAllFocusNode.dispose();
//     _scrollController.dispose();
//     super.dispose();
//   }
// }

// SubLiveScreen.dartimport 'package:mobi_tv_entertainment/home_screen_pages/sub_live_screen/channels_category.dart';
// constants.dart - Create this file for shared constants
